...
const nav_height = (0,_util_geometry_js__WEBPACK_IMPORTED_MODULE_0__.element_geometry)(navbar).h;
const nav_dropdown = document.querySelector('.nav-dropdown');
const nav_dropdown_height = (0,_util_geometry_js__WEBPACK_IMPORTED_MODULE_0__.element_geometry)(nav_dropdown).h;
...
const slide = (className) => {
  ...
  const click_outside_of_element_listener = (event) => {
    ...
    const {y1: element_top, y2: element_bottom} = (0,_util_geometry_js__WEBPACK_IMPORTED_MODULE_0__.element_geometry)(element);
    const {viewport_height: vh} = (0,_util_geometry_js__WEBPACK_IMPORTED_MODULE_0__.viewport_geometry)();
...
const open = () => {
  ...
  if (is_nav_dropdown_open === false) {
    master_timeline = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline();
...
/* harmony export */   "element_geometry": () => (/* binding */ element_geometry),
/* harmony export */   "get_center_shifts": () => (/* binding */ get_center_shifts)
/* harmony export */ });
// ========================================================
